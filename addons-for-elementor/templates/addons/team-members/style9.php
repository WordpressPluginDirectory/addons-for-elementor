<?php
/**
 * Team Member Template 9
 *
 * This template can be overridden by copying it to mytheme/addons-for-elementor/addons/team-members/style9.php
 *
 */
...
<div class="lae-team-member-wrapper">
    ...
    <div class="lae-team-member <?php echo $class_attr; ?>" <?php echo $data_attr; ?>>
        ...
        <div class="lae-team-member-text">
            ...
            <div class="lae-team-member-footer">
